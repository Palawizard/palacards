...
/** Fiche d'un article (GET /cards/:id). */
...
/**
 * Contenu d'une fiche carte, partagé par la page /card/[id] (chargement direct) et la fenêtre
 * superposée ouverte depuis n'importe quelle vignette (route interceptée : l'écran d'origine, par
 * exemple une ouverture de paquet en cours, reste monté dessous).
 */
export function CardSheetView({
  ...
  return (
    <article className="flex flex-col gap-2">
      {modal ? (
        <h2 id={titleId} className="page-title text-[clamp(1.55rem,1.25rem+1.3vw,2.2rem)]">
          {card.title}
        </h2>
      ) : (
      ...
      >
        ...
        {/* Conteneur de requêtes : la colonne est plus étroite dans la fenêtre superposée que sur la page. */}
